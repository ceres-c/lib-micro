...
mwe: include/inst.h mwe.c
	$(CC) -m32 -O0 -no-pie -ggdb -Wall -masm=intel -Wmissing-field-initializers -Wno-unused-function -Wno-unused-variable -I include/ mwe.c -o mwe
